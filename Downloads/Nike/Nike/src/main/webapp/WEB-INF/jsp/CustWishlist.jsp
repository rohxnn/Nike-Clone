...
<body>
    ...
    text-align: end;
">
               <a href="view/${Item.p.id }"> <button style="background-color: black; color: white; font-weight: bold;"  >Add to Cart</button>     </a>
                   </div>

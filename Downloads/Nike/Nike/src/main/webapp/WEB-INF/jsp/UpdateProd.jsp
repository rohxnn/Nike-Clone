    ...
    <div class="container mt-4">
        ...
        <div id="view-products" class="section">
            ...
            <div class="container">
                ...
                <form id="addProductForm" action="/Admin/UpdateSub/${prod.id}" method="post">
                  ...
                  <input type="number" id="productPrice" name="price" min="0.01" step="0.01" value="${prod.price }" required>
                  
  
                   <label for="productImage">Product Image URL</label>
                  <input type="text" id="productImage" name="image" value="${prod.image }" required>
                  
                  <label for="productImage">Quantity</label>
                  <input type="number" id="productImage" name="quantity" value="${prod.quantity }" required>
